...
// SimpleDeviceEmulator.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CSimpleDeviceEmulatorApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CSimpleDeviceEmulatorApp

CSimpleDeviceEmulatorApp::CSimpleDeviceEmulatorApp()
{
...
// Единственный объект CSimpleDeviceEmulatorApp

CSimpleDeviceEmulatorApp theApp;


// инициализация CSimpleDeviceEmulatorApp

BOOL CSimpleDeviceEmulatorApp::InitInstance()
{
