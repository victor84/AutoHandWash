...
enum class e_command_from_device : byte
{
	...
	// CMD=0x01 Нажата кнопка, DATA0 = 0x00… 0x08
	button_press = 0x01,
	...
	// 7й бит = кнопка8, 0й бит = кнопка1, 1 = кнопка нажата, DATA1 остальные
	buttons_state = 0x0c,
...
enum class e_command_from_pc : byte
{
	...
	// CMD=0x10 Включить клапан. DATA0=0x00…0x08 – номер клапана
	open_valve = 0x10,

	// CMD=0x20 Выключить клапан. DATA0=0x00…0x08 – номер клапана
	close_valve = 0x20,
