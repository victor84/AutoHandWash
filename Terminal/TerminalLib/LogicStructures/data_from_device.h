...
enum class e_device_error_code : byte
{
	...
	eeprom_unkhown_address = 0x0A,		// ошибка записи / чтения EEPROM(неверный адрес ячейки)
	incorrect_data = 0x0E,				// некорректная посылка
	unknown_command = 0x0F				// неверная команда
};
