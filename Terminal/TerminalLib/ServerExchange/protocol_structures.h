...
enum e_distribute_element_status : byte
{
...
#pragma pack(push, 1)
// выдача приза
struct tag_distribute_prize_packet
{
	e_distribute_element_status	status;	// статус выдачи
	uint16_t					size;	// размер выданного приза
};
#pragma pack(pop)
...
#pragma pack(push, 1)
// выдача приза
struct tag_distribute_discount_card_packet
{
	e_distribute_element_status	status;	// статус выдачи
};
#pragma pack(pop)
