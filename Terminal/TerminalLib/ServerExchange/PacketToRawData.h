...
{
// создаЄт сырые данные из пакета
...
public:
	...
	// создание данных дл€ отправки из пакета транспортного уровн€
	...
	// создание сырых данных пакета со счЄтчиками
	...
	// создание сырых дфнных пакета состо€ни€ терминала
